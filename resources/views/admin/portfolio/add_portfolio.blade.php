    ...
    <div class="container-fluid">
      <div class="dash-head">
        <div class="dash_title">
          ...
          <h2 class="main-title text-wrap">Add Portfolio</h2>
        </div>
      ...
      <div class="container-fluid">
        <div class="card">
          ...
          <div class="card-body">
            <form class="upload-form" action="{{ route('admin.portfolioStore') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
              @csrf
              <div class="row">
                <div class="col-12 col-md-6">
                  ...
                  <div class="form-group">
                    <label
                      for="btnLink"
                      class="col-form-label form-label">Slug
                      <span class="text-danger">*</span></label>
                    <input
                      type="text"
                      id="btnLink"
                ...
                <div class="form-group">
                    <label
                      ...
                      class="col-form-label form-label">Country <span class="text-danger">*</span></label>
                    <select
                      id="country"
                      name="country"
                  ...
                  <div class="form-group">
                    <label
                      for="industryName"
                      class="col-form-label form-label">Industry
                      <span class="text-danger">*</span></label>
                    <input
                      type="text"
                      id="industryName"
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    <label
                      ...
                      class="col-form-label form-label">Short Description <span class="text-danger">*</span></label>
                    <textarea
                ...
                <div class="col-12 col-md-6 ">
                  <div class="form-group">
                    <label
                      for="solution"
                      class="col-form-label form-label">Solution
                      <span class="text-danger">*</span></label>
                    <input
                      type="text"
                      id="solution"
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  <label for="html_content" class="col-form-label form-label">Description</label>
                ...
                <div class="col-12 col-md-6 ">
                  <div class="form-group">
                    <label for="inputBannerImage" class="form-label">Image <span class="text-danger">*</span></label>
                    <div class="form-group mb-20 upload-input">
                      ...
                      <input type="file" name="image" class="form-control d-none" id="bannerImg" required onchange="previewBannerImage(event)" data-parsley-required="true" />
                    </div>
