      ...
      <div class="container-fluid">
        ...
        <div class="card">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <p class="text-nowrap">{{$socialLink->title}}</p>
                    </td>
                    ...
                    <td class="table_action">
                      <div class="d-inline-flex justify-content-center align-items-center gap-3">
                                  ...
                                  <form class="upload-form" action="{{ route('admin.socialLinkUpdate', $socialLink->id) }}"
                                    ...
                                    <div
                                      ...
                                      <div
                                        ...
                                        <label
                                          for="inputTitle"
                                          class="col-form-label form-label">Social Link
                                        </label>
                                      </div>
                                      ...
                                      <div class="col-9">
                                        <div class="mb-3 mt-3">
                                          <input
                                            ...
                                            value="{{ old('slug', $socialLink->slug ?? '') }}"
                                            required />
                                        </div>
                                      </div>
                        ...
                        <a
                          ...
                          data-bs-toggle="modal"
                          data-bs-target="#deleteModal-{{$socialLink->id}}"
                          title="delete">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            height="12"
                        ...
                        <a
                          ...
                          data-bs-toggle="modal"
                          data-bs-target="#showModal-{{$socialLink->id}}"
                          title="View"><svg
                            xmlns="http://www.w3.org/2000/svg"
                            height="12"
                            viewBox="0 -960 960 960"
                              ...
                              <div class="modal-body my-3">
                                ...
                                <div>
                                  <form action="{{ route('admin.socialLinkStatusUpdate', $socialLink->id) }}" method="POST">
                                    ...
                                    <button type="submit" class="btn {{ $socialLink->status == 1 ? 'btn-danger' : 'btn-primary' }} del_modal">
                                      {{ $socialLink->status == 1 ? 'Hide' : 'Show' }}
                                    </button>
                                  </form>
                                </div>
          ...
          <div class="card-footer">
            <p>Showing {{ $socialLinks->firstItem() }} to {{ $socialLinks->lastItem() }} of {{ $socialLinks->total() }} entries</p>
