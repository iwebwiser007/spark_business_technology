              ...
              <div class="row form-group mt-1 mt-md-2">
                ...
                <div class="col-12 col-md-3">
                  <label
                    ...
                    class="col-form-label form-label d-flex justify-content-left justify-content-md-center">Certificate Title
                  </label>
                </div>
                ...
                <div class="col-12 col-md-8 mt-0">
                  <input
                    ...
                    placeholder="Enter Certicate Title..."
              ...
              <div class="row form-group">
                ...
                <div class="col-12 col-md-8 mt-0">
                  <div class="form-group mb-20 upload-input">
                    ...
                    <input type="file" name="image" class="form-control form-control-lg d-none" id="iconImg" required onchange="previewIconImage(event)" data-parsley-required="true" />
                  </div>
