    ...
    <div class="container-fluid">
      ...
      <div class="dash-head">
        ...
        <div class="alert alert-success alert-dismissible fade show mt-3 d-flex justify-content-between align-items-center" role="alert">
          <div><strong>Success:</strong> {{ Session::get('success_message') }}</div>
                ...
                <div class="form-group mb-20 upload-input">
                  <label for="iconImg" class="form-label form-img-uploader rounded-4 d-flex align-items-center justify-content-center w-100 py-4">
                    <div class="d-flex flex-column align-items-center gap-3">
                      <span id="iconIcon">
                        <span>
                          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" viewBox="0 0 512.056 512.056">
                            <g>
                  ...
                  <input type="file" name="image" class="form-control d-none" id="iconImg" required onchange="previewIconImage(event)" data-parsley-required="true" />
                </div>
