                  ...
                  <div class="container-fluid">
                    ...
                    <div class="card">
                      ...
                      <div class="card-header">
                        ...
                        >
                          <h2>Blog List</h2>
                          <a href="add_blog.html" class="btn sub_btn">ADD</a>
                        </div>
                      </div>
                          ...
                          <table class="table table-hover">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <!-- Link start here  -->
                                <td>
                                  <p class="text-truncate">www.iwebwiser.com</p>
                                </td>
                                <!-- link end here  -->
                                ...
                                <!-- blog view, edit and delete button end here  -->
                              </tr>
                              <!-- blog-1 end here  -->

                              <!-- blog-2 start here  -->
                              <tr>
                                <!-- blog-2 image start here -->
                                <td class="list_img">
                                  <div class="table_img">
                                    <img
                                ...
                                <!-- blog-2 image end here  -->

                                <!-- blog-2 title start here  -->
                                <td>
                                  <p class="text-nowrap">Blog-2</p>
                                </td>
                                <!-- blog-2 title end here  -->

                                <!-- blog-2 Description start here  -->
                                <td class="banner_desc">
                                  <p class="desc text-truncate">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.
                                ...
                                <!-- blog-2 view, edit and delete button start here  -->
                                <td class="table_action">
                                  <div
                                    class="d-inline-flex justify-content-center align-items-center gap-3"
                                  >
                                ...
                                <!-- blog-2 view, edit and delete button end here  -->
                              </tr>
                              <!-- blog-2 end here  -->

                              <!-- blog-3 start here  -->
                              <tr>
                                <!-- blog-3 image start here -->
                                <td class="list_img">
                                  <div class="table_img">
                                    <img
                                ...
                                <!-- blog-3 image end here  -->

                                <!-- blog-3 title start here  -->
                                <td>
                                  <p class="text-nowrap">Blog-3</p>
                                </td>
                                <!-- blog-3 title end here  -->

                                <!-- blog-3 Description start here  -->
                                <td class="banner_desc">
                                  <p class="desc text-truncate">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.
